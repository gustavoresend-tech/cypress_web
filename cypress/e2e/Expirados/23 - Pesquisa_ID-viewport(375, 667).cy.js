...
// E: a resolução configurada é: 375x667
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (375, 667)', () => {
        ...
        cy.screenshot('23-Menu de Pesquisa',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('23-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('23-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('23-Pesquisa 03',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('23-Pesquisa 04',{overwrite: true});
