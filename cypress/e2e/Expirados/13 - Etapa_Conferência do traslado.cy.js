    ...
    // E: aprovo as atividades da etapa: Conferência do traslado
    // ENTAO: o card deve se mover para a etapa: Protocolo de cessão


    describe('Validar etapa: "Conferência do traslado"', () => {
        beforeEach(() => {
        ...
        // clicar em "Conferência do traslado assinado"
        cy.contains('Conferência do traslado assinado').click();
