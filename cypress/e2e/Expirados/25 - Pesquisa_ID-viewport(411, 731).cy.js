...
// E: a resolução configurada é: 411x731
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (411, 731)', () => {
        ...
        cy.screenshot('25-Menu de pesquisa',{overwrite: true});      
        ...
        // Captura print para evidencia
        cy.screenshot('25-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('25-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('25-Pesquisa 03',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('25-Pesquisa 04',{overwrite: true});
