    ...
    // E: aprovo as atividades da etapa: Confecção de documentos
    // ENTAO: o card deve se mover para a etapa: Assinatura


    describe('Validar etapa: "Confecção de documentos"', () => {
        beforeEach(() => {
        ...
        // clicar em "Emissão da minuta"
        cy.contains('Emissão da minuta').click();
