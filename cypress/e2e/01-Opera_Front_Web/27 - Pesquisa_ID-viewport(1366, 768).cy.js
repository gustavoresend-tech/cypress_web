...
// E: a resolução configurada é: 1366x768
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (1366, 768)', () => {
        ...
        cy.screenshot('27-Menu de pesquisa',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('27-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('27-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('27-Pesquisa 03',{overwrite: true});
        ...
        cy.wait(1000); // aguarda 1 segundos
        // Captura print para evidencia
        cy.screenshot('27-Pesquisa 04',{overwrite: true});
