...
// E: a resolução configurada é: 360x720
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (360, 720)', () => {
        ...
        cy.screenshot('22-Menu de pesquisa',{overwrite: true});        
        ...
        // Captura print para evidencia
        cy.screenshot('22-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('22-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('22-Pesquisa 03',{overwrite: true});
