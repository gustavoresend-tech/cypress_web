...
// E: a resolução configurada é: 768x1024
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (768, 1024)', () => {
        ...
        cy.screenshot('26-Menu de pesquisa',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('26-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('26-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('26-Pesquisa 03',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('26-Pesquisa 04',{overwrite: true});
