...
// E: a resolução configurada é: 375x812
...
describe('Validar Tela de pesquisa ID - Responsivo', () => {
    ...
    it('Validar Pesquisa ID - (375, 812)', () => {
        ...
        cy.screenshot('24-Menu de pesquisa',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('24-Pesquisa 01',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('24-Pesquisa 02',{overwrite: true});
        ...
        cy.get('.mx-auto > .text-2').contains('Operação encontrada!');
        // Captura print para evidencia
        cy.screenshot('24-Pesquisa 03',{overwrite: true});
        ...
        // Captura print para evidencia
        cy.screenshot('24-Pesquisa 04',{overwrite: true});
