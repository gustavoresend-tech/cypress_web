...
// Colunas: TIPO, DATA, AÇÕES
    ...
    it('Validar aba "Todos os arquivos"', () => {
        ...
        cy.get('#select-tipo-documento-upload-arquivo').select('CPF');
        // clica no btn "Enviar"
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('Comprovante de Endereço');
        // clica no btn "Enviar"
        cy.get('#btn-enviar-arquivo-operacao').click();
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('Certidão de Casamento');
        // clica no btn "Enviar"
        cy.get('#btn-enviar-arquivo-operacao').click();
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('Cópia Processo');
        // clica no btn "Enviar"
        cy.get('#btn-enviar-arquivo-operacao').click();
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('Folha de Cálculo');
        // clica no btn "Enviar"
        cy.get('#btn-enviar-arquivo-operacao').click();
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('CND Federal');
        ...
        // seleciona o tipo de documento       
        cy.get('#select-tipo-documento-upload-arquivo').select('CND Estadual');
        // seleciona status CND
